...
// Import único con orden determinista para estilos del perfil
                            ...
                            {(() => {
                              ...
                              return avatarUrl ? (
                                <img
                                  ...
                                  onError={(e) => {
                                    try {
                                      // Evitar mutar el árbol DOM fuera de React (causa NotFoundError)
                                      // Fallback seguro: usar imagen local por defecto y agregar título con iniciales
                                      e.currentTarget.onerror = null;
                                      e.currentTarget.src = '/images/fotoperfil.jpg';
                                      e.currentTarget.title = iniciales;
                                    } catch {}
                                  }}
                                />
                              ) : (
                              ...
                              <img
                                ...
                                onError={(e) => {
                                  try {
                                    e.currentTarget.onerror = null;
                                    e.currentTarget.src = '/images/fotoperfil.jpg';
                                    e.currentTarget.title = initials;
                                  } catch {}
                                }}
                              />
                            ) : (

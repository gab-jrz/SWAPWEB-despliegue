...
const ChatBubble = ({
  ...
  // Actualizar imagen de perfil cuando cambian las props relevantes
  useEffect(() => {
    const next = fromMe
      ? (currentUserProfileImage || '/images/fotoperfil.jpg')
      : (senderProfileImage || '/images/fotoperfil.jpg');
    setProfileImage(next);
    setImageError(false);
  }, [fromMe, senderProfileImage, currentUserProfileImage]);
    ...
    >
      ...
      >
        <img
          ...
          src={profileImage || '/images/fotoperfil.jpg'}
          alt={displayName}
